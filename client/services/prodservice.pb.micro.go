...
type ProdService interface {
	GetProdsList(ctx context.Context, in *ProdsRequest, opts ...client.CallOption) (*ProdsResponse, error)
}
...
func (c *prodService) GetProdsList(ctx context.Context, in *ProdsRequest, opts ...client.CallOption) (*ProdsResponse, error) {
	req := c.c.NewRequest(c.name, "ProdService.GetProdsList", in)
	out := new(ProdsResponse)
...
type ProdServiceHandler interface {
	GetProdsList(context.Context, *ProdsRequest, *ProdsResponse) error
}

func RegisterProdServiceHandler(s server.Server, hdlr ProdServiceHandler, opts ...server.HandlerOption) error {
	type prodService interface {
		GetProdsList(ctx context.Context, in *ProdsRequest, out *ProdsResponse) error
	}
	type ProdService struct {
		prodService
	}
...
func (h *prodServiceHandler) GetProdsList(ctx context.Context, in *ProdsRequest, out *ProdsResponse) error {
